...
class TeamController {
    ...
    @GetMapping("/sprintVelocity/{prodBacklog}")
    fun getSprintVelocity(@PathVariable prodBacklog:String):ResponseEntity<Any>{
        var sprintvelo = iSprintService.getSprintVelocity(prodBacklog)
        return ResponseEntity(sprintvelo, HttpStatus.OK)
    }
}